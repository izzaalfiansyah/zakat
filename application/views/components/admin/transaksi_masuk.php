	...
	<div class="card-header">
		<div class="row">
			...
			<div class="col-md-6" align="right">
				<a class="btn btn-danger" target="_blank" href="<?= base_url('admin/laporan/masuk') ?>">Print</a>
						...
						<tr>
							...
							<td class="text-center">
								<button class="btn btn-sm btn-edit btn-primary" type="button" onclick="edit({
									id: '<?= $item->id ?>',
									id_zakat: '<?= $item->id_zakat ?>',
									id_muzakki: '<?= $item->id_muzakki ?>',
									jumlah: '<?= $item->jumlah ?>',
...
<div class="modal fade" id="create">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="<?= base_url('admin/transaksi_masuk/store') ?>" method="post">
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<select name="id_muzakki" class="form-control" required="true">
					...
					<div class="form-group">
						...
						<select name="id_zakat" class="form-control" required="true">
...
<div class="modal fade" id="edit">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="<?= base_url('admin/transaksi_masuk/update') ?>" method="post">
				<div class="modal-header">
...
<div class="modal fade" id="delete">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="<?= base_url('admin/transaksi_masuk/destroy') ?>" method="post">
				<div class="modal-header">
